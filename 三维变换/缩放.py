...
if __name__ == '__main__':
    coord = o3d.geometry.TriangleMesh.create_coordinate_frame(size=0.5, origin=[0, 0, 0])  # 设置坐标系
    ...
    points[:, 0] = points[:, 0] + 0.5  # 质心平移到x=0.5处
    ...
    # 采用scale函数
    pcd2 = deepcopy(pcd)
    pcd2.scale(2.0, (0.5, 0, 0))  # 点云放大两倍，质心平移至(-0.5, 0, 0)
    ...
    # 点云显示
    o3d.visualization.draw_geometries([coord, pcd, pcd1, pcd2],  # 点云列表
                                      window_name="点云缩放",
